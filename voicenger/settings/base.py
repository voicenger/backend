...
SOCIAL_AUTH_AUTH0_DOMAIN = config('APP_DOMAIN', default='')
SOCIAL_AUTH_AUTH0_KEY=config('APP_CLIENT_ID', default='') 
SOCIAL_AUTH_AUTH0_SECRET=config('APP_CLIENT_SECRET', default='')
