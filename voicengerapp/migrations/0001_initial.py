# Generated by Django 4.2.14 on 2024-08-07 19:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_type', models.CharField(choices=[('Private', 'Private'), ('Group', 'Group'), ('Anonim Group', 'Anonim Group'), ('Channel', 'Channel')], max_length=50)),
        ...
        migrations.AddField(
            model_name='message',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='voicengerapp.user'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='voicengerapp.user')),
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='voicengerapp.groupchat')),
            ],
        ),
    ]
